...
export const PricingSection = () => {
  return (
    <section id="membership-plans" className="bg-black py-12 px-6 font-montserrat">
      <motion.h2
        ...
        {plans.map((plan) => (
          ...
          >
            <div>
              ...
              <p className="text-center text-sm uppercase tracking-[0.2em] text-white/70 mb-6">
                {plan.price}
              </p>
            ...
            <div className="flex gap-2 max-[1140px]:flex-col max-lg:flex-row">
              <Link href="#join-now" className="w-full text-center flex-1 py-2 border border-white text-white font-bold hover:bg-white hover:text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gymYellow/80 transition font-montserrat rounded-full cursor-pointer">FREE TRIAL</Link>
              <Link href="#classes" className="w-full text-center flex-1 py-2 bg-gymYellow text-black font-bold hover:bg-gymYellow/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gymYellow/80 transition font-montserrat rounded-full cursor-pointer">LEARN MORE</Link>
            </div>
          </motion.div>
        ))}
      </div>
