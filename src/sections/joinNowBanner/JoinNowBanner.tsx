        ...
        <div className="relative overflow-hidden  border border-white/10">
          <div className="relative h-[400px] md:h-[500px] lg:h-[580px]">
            ...
            <div className="absolute inset-x-0 top-[70%] -translate-y-2/3 flex px-6 md:px-10">
              <div>
                <p className="text-gymYellow font-teko uppercase font-black text-5xl sm:text-7xl md:text-[120px] lg:text-[180px] leading-none">
                  50% Off
                </p>
          ...
          <div className="relative h-16 md:h-20 overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center px-6 md:px-10">
              <Link href="#membership-plans" className="px-6 py-2 md:px-8 lg:px-10 md:py-3 text-base md:text-lg bg-white text-black font-bold rounded-full uppercase tracking-tight hover:bg-[#f5f5f5] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gymYellow/80 transition">
