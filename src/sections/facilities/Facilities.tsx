  ...
  return (
    <section id="facilities" className="bg-black py-20 px-4 font-montserrat">
      ...
      >
        <button
          type="button"
          className="px-8 py-3 bg-gymYellow text-black font-bold rounded-full uppercase tracking-tighter font-montserrat hover:bg-gymYellow/90 cursor-pointer transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gymYellow focus-visible:ring-offset-2 focus-visible:ring-offset-black"
        >
